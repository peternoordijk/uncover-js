 ...
 * @param  {Array|object} arr    A nested object or array. Example: {"name":"Jungle Book","keywords":["test","..."],"animals":[{"name":"Beer","character":{"name":"Baloo"}},{"name":"Wolf","characters":[{"name":"Akela"},{"name":"Rama"}]}]}
